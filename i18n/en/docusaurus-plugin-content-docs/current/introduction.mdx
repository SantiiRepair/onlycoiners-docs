...
We have created a website where you can make a profile, connect with people by following them. and share posts like on Twitter and chat with others, You can also use crypto wallets and swap features to easily send and trade cryptocurrencies with others.

What we want is to make it a reliable website for crypto users, so you can feel secure using its various social and blockchain features.

In the future, we want this to be a platform where you can also earn money by creating posts, similar to what you have seen on /r/cryptocurrency with communities or Twitter with verified users.
